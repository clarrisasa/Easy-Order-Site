 ...
 <div class="row">
    ...
    <div class="row">
	 <div class="col-md-12 articeles" id="site-content">
		...
		<aside class="widgets">
		<p> </p>
		<center><h4>EDIT DATA MINUMAN</h4></center><br>
<center>
<?php
    include "koneksimakan_proyek.php" ;

    $data = mysqli_query($cek, "select * FROM minum where nmrmeja LIKE '%$_GET[nmrmeja]%'");
...
<form action="" method="POST">
    ...
    <td>Pesanan</td><br>
    <input type="text" name="pesan" value="<?php echo $pesan;?>"><br><br>
    <input type="submit" name="submit" value="Edit Data Minuman"><br>
</form>
<?php
include "koneksimakan_proyek.php";
    if(isset($_POST['submit'])) {
        $data = mysqli_query($cek, "UPDATE `minum` SET `nama` = '$_POST[nama]', `nmrmeja` = '$_POST[nmrmeja]', `hp` = '$_POST[hp]', `pesan` = '$_POST[pesan]' WHERE `minum`.`nmrmeja` = '$_GET[nmrmeja]'");
